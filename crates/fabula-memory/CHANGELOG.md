...
## [0.2.0](https://github.com/patricker/fabula/compare/fabula-memory-v0.1.0...fabula-memory-v0.2.0) - 2026-05-15

### Added

- *(memory)* MemGraph::add_event helper for multi-tag events
