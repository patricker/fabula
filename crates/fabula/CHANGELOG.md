...
## [0.2.0](https://github.com/patricker/fabula/compare/fabula-v0.1.0...fabula-v0.2.0) - 2026-09-02

### Added

- *(scoring)* RoleConditionedStuScorer aggregation and Match scoring
- *(scoring)* RoleConditionedStuScorer skeleton
- *(narratives)* assemble_signals_with_significance aggregator
- *(engine)* SiftEngine::pattern_importance_map() helper
...
- cargo fmt drift across engine + tests
- *(scoring)* worked example for RoleConditionedStuScorer
- *(scoring)* expose PropertyTable to crate-internal use
- *(engine)* example showing pattern_importance_map flow
