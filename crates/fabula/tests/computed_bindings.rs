...
use fabula::engine::{evaluate_pattern, DefaultLetEvaluator, SiftEngine, SiftEvent};
...
fn let_in_incremental_evaluation_matches_deadline() {
    ...
    let mut engine =
        SiftEngine::<String, String, TestVal, i64, DefaultLetEvaluator>::new(DefaultLetEvaluator);
    engine.register(p);
