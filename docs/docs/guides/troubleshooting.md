...
**Fix:** See the [Performance tuning checklist](./performance#tuning-checklist) for the standard remediations -- `drain_completed`, `set_pattern_enabled(idx, false)`, deadlines, and adapter choice.
